...
- Pflege bei Fertigloesungen
- Vorsicht bei Eigenbauten
- EInmal im System kann ein Angreifer die ganze Seite uebernehmen

---

## CMS und Wartungsaufwand

- Sicherheitsupdates moeglichst schnell einspielen
- Wartung und Updates sicherstellen
- Updates koennen den Code brechen
- Plugin Hoelle
...
- Webserver und PHP skalieren noch ganz gut
- Jegliche Form der Datenspeicherung schwer oder nur unsauber replizierbar
- Generierung der Seite steiger Serverlast
- Potenzielle Ausfaelle durch hohe Nachfrage
...
- Tooling zum generieren statischer Seiten
...
## Gegendarstellung Motivation (Sicherheit, Wartung, Skalierung)

---

### CMS und Sicherheitsluecken

- Seiten sind bereits generiert
- kein direkter Angriffsvektor
- APIs weiter angreifbar falls dynamisch eingebunden!

---

### CMS und Wartungsaufwand

- Je nach Methode ist der Wartungsaufwand gleich null
- Frontend Technologien koennen altern (deprecated CSS, JS, HTML, ...)
- API Server muss gewartet werden
- Da Kommunikation mit API ueber Standards keine Anpassung an unnoetige Specs notwendig
